...
#define UserStack	(STACK_BASE-0x3800)
#define SVCStack	(STACK_BASE-0x2800)	
#define UndefStack	(STACK_BASE-0x2400)
#define AbortStack	(STACK_BASE-0x2000)	
#define IRQStack	(STACK_BASE-0x1000)
#define FIQStack	(STACK_BASE-0x0)
