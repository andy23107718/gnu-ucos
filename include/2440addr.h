...
#define pIRQ_EINT0		(*(unsigned *)(_IRQ_STARTADDRESS+0x0))
#define pIRQ_EINT1		(*(unsigned *)(_IRQ_STARTADDRESS+0x4))
#define pIRQ_EINT2		(*(unsigned *)(_IRQ_STARTADDRESS+0x8))
#define pIRQ_EINT3		(*(unsigned *)(_IRQ_STARTADDRESS+0xc))
#define pIRQ_EINT4_7		(*(unsigned *)(_IRQ_STARTADDRESS+0x10))
#define pIRQ_EINT8_23	 	(*(unsigned *)(_IRQ_STARTADDRESS+0x14))
#define pIRQ_CAM		(*(unsigned *)(_IRQ_STARTADDRESS+0x18))		// Added for 2440.
#define pIRQ_BAT_FLT  		(*(unsigned *)(_IRQ_STARTADDRESS+0x1c))
#define pIRQ_TICK		(*(unsigned *)(_IRQ_STARTADDRESS+0x20))
#define pIRQ_WDT_AC97		(*(unsigned *)(_IRQ_STARTADDRESS+0x24))   //Changed to pIRQ_WDT_AC97 for 2440A 
#define pIRQ_TIMER0	 	(*(unsigned *)(_IRQ_STARTADDRESS+0x28))
#define pIRQ_TIMER1	 	(*(unsigned *)(_IRQ_STARTADDRESS+0x2c))
#define pIRQ_TIMER2		(*(unsigned *)(_IRQ_STARTADDRESS+0x30))
#define pIRQ_TIMER3		(*(unsigned *)(_IRQ_STARTADDRESS+0x34))
#define pIRQ_TIMER4		(*(unsigned *)(_IRQ_STARTADDRESS+0x38))
#define pIRQ_UART2		(*(unsigned *)(_IRQ_STARTADDRESS+0x3c))
#define pIRQ_LCD		(*(unsigned *)(_IRQ_STARTADDRESS+0x40))
#define pIRQ_DMA0		(*(unsigned *)(_IRQ_STARTADDRESS+0x44))
#define pIRQ_DMA1		(*(unsigned *)(_IRQ_STARTADDRESS+0x48))
#define pIRQ_DMA2		(*(unsigned *)(_IRQ_STARTADDRESS+0x4c))
#define pIRQ_DMA3		(*(unsigned *)(_IRQ_STARTADDRESS+0x50))
#define pIRQ_SDI		(*(unsigned *)(_IRQ_STARTADDRESS+0x54))
#define pIRQ_SPI0		(*(unsigned *)(_IRQ_STARTADDRESS+0x58))
#define pIRQ_UART1		(*(unsigned *)(_IRQ_STARTADDRESS+0x5c))
#define pIRQ_NFCON		(*(unsigned *)(_IRQ_STARTADDRESS+0x60))		// Added for 2440.
#define pIRQ_USBD		(*(unsigned *)(_IRQ_STARTADDRESS+0x64))
#define pIRQ_USBH		(*(unsigned *)(_IRQ_STARTADDRESS+0x68))
#define pIRQ_IIC		(*(unsigned *)(_IRQ_STARTADDRESS+0x6c))
#define pIRQ_UART0		(*(unsigned *)(_IRQ_STARTADDRESS+0x70))
#define pIRQ_SPI1		(*(unsigned *)(_IRQ_STARTADDRESS+0x74))
#define pIRQ_RTC		(*(unsigned *)(_IRQ_STARTADDRESS+0x78))
#define pIRQ_ADC		(*(unsigned *)(_IRQ_STARTADDRESS+0x7c))
